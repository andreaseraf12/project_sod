...
//Funzione per confrontare la data prima dell'invio di ogni messaggio su seriale
...
void Task_Sensors(void *pvParameters){  // This is a task.
  ...
  for (;;){
    ...
    message.temperatura = 24.5;    //leggo temperatura
    message.pressione = 1.01; //leggo pressione 
   /*
